package uz.pdp.customer_service.exceptions;
...
import uz.pdp.customer_service.payload.ApiResult;
import uz.pdp.customer_service.payload.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleException(AccessDeniedException ex) {
        ...
        return new ResponseEntity<>(ApiResult.errorResponse("DO_NOT_HAVE_PERMISSION_TO_USE_THIS_WAY", 400), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<?> handleException(MissingPathVariableException ex) {
        ...
        return new ResponseEntity<>(ApiResult.errorResponse("PAGE_NOT_FOUND", 404), HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<?> handleException(HttpRequestMethodNotSupportedException ex) {
        log.error("HttpRequestMethodNotSupportedException -> {} ", ex.getMethod());
        return new ResponseEntity<>(ApiResult.errorResponse("METHOD_ERROR", 405), HttpStatus.METHOD_NOT_ALLOWED);
    }
    ...
    public ResponseEntity<?> handleException(HttpMediaTypeNotAcceptableException ex) {
        ...
        return new ResponseEntity<>(ApiResult.errorResponse("UNACCEPTABLE", 406), HttpStatus.NOT_ACCEPTABLE);
    }
    ...
    public ResponseEntity<?> handleException(HttpMediaTypeNotSupportedException ex) {
        ...
        return new ResponseEntity<>(ApiResult.errorResponse("METHOD_ERROR", 415), HttpStatus.METHOD_NOT_ALLOWED);
    }
    ...
    public final ResponseEntity<?> handleResourceNotFoundException(NoResourceFoundException ex) {
