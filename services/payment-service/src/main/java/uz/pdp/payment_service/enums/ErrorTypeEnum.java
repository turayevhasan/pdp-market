package uz.pdp.payment_service.enums;
...
public enum ErrorTypeEnum {
    ...
    ACTIVE_PAYMENT_NOT_FOUND(HttpStatus.NOT_FOUND),
    PAYMENT_ALREADY_EXISTS_FOR_THIS_ORDER(HttpStatus.CONFLICT),
    THIS_ORDER_PAYMENT_IN_PROGRESS,
